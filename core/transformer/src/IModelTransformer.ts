...
import { AccessToken, CompressedId64Set, DbResult, Guid, Id64, Id64Set, Id64String, IModelStatus, Logger, LogLevel, MarkRequired, YieldManager } from "@itwin/core-bentley";
...
import { IModelImporter, IModelImporterState } from "./IModelImporter";
...
export interface TransformationState {
  ...
  deferredElementIds: CompressedId64Set;
}
